-- ============================================================================
-- m1 — foundation: organisaties, memberships, gebouwen, units, eigenaars, ownership
-- ============================================================================
--
-- HISTORISCHE PLAATSHOUDER — BEWUST LEEG.
--
-- Deze migratie is op 22/24-08-2026 rechtstreeks op het project toegepast
-- (zie supabase_migrations.schema_migrations, versie 20260822175325),
...
DO $m$ BEGIN
  RAISE NOTICE 'Historische plaatshouder 20260822175325 — geen effect.';
END $m$;