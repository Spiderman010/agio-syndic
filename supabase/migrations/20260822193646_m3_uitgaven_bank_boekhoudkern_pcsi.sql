-- ============================================================================
-- m3 — uitgaven, bank, boekhoudkern en PCSI-rekeningschema
-- ============================================================================
--
-- HISTORISCHE PLAATSHOUDER — BEWUST LEEG.
--
-- Deze migratie is op 22/24-08-2026 rechtstreeks op het project toegepast
-- (zie supabase_migrations.schema_migrations, versie 20260822193646),
...
DO $m$ BEGIN
  RAISE NOTICE 'Historische plaatshouder 20260822193646 — geen effect.';
END $m$;