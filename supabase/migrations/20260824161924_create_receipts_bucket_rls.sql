-- ============================================================================
-- storage — receipts-bucket en bijbehorende RLS (grotendeels vervangen door m8)
-- ============================================================================
--
-- HISTORISCHE PLAATSHOUDER — BEWUST LEEG.
--
-- Deze migratie is op 22/24-08-2026 rechtstreeks op het project toegepast
-- (zie supabase_migrations.schema_migrations, versie 20260824161924),
...
DO $m$ BEGIN
  RAISE NOTICE 'Historische plaatshouder 20260824161924 — geen effect.';
END $m$;